...
from get_data_elasticsearch import get_max_cpu, get_max_memory, get_mysql_max_connected, get_mysql_error
...
def run_memory_check(scheduler):
    ...
    get_max_memory(memory_max, time_loop, el_host, el_user, el_pass)
    
    
memory_scheduler = sched.scheduler(time.time, time.sleep)

def run_cpu_check(scheduler):
    # schedule the next call first
    scheduler.enter(time_loop, 1, run_cpu_check, (scheduler,))
    get_max_cpu(cpu_max, time_loop, el_host, el_user, el_pass)
cpu_scheduler = sched.scheduler(time.time, time.sleep)

class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(909, 857)
        ...
        self.main_windows.setGeometry(QtCore.QRect(20, 10, 861, 701))
        ...
        self.endBtn.setGeometry(QtCore.QRect(630, 640, 93, 28))
        ...
        self.eHosts.setObjectName("https://localhost:9200/")
        self.eHosts.setText("https://localhost:9200/")
        self.eHosts.setPlaceholderText("elastic")
        ...
        self.eUser.setText("elastic")
        self.eUser.setPlaceholderText("elastic")
        ...
        self.closeBtn.setGeometry(QtCore.QRect(740, 640, 93, 28))
        self.closeBtn.setObjectName("closeBtn")
        self.groupBox_3 = QtWidgets.QGroupBox(self.page)
        self.groupBox_3.setGeometry(QtCore.QRect(30, 620, 171, 51))
        ...
        self.timeSpinBox.setProperty("value", 30.0)
        ...
        self.startBtn.setGeometry(QtCore.QRect(510, 640, 93, 28))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 20, 461, 41))
        ...
        self.metric_source = QtWidgets.QLineEdit(self.layoutWidget1)
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(490, 20, 291, 41))
        ...
        self.metric_name = QtWidgets.QLineEdit(self.layoutWidget3)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(20, 80, 761, 51))
        ...
        self.metric_system = QtWidgets.QCheckBox(self.layoutWidget4)
        ...
        self.metric_other_module = QtWidgets.QLineEdit(self.layoutWidget4)
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(20, 20, 461, 41))
        ...
        self.filebeat_source = QtWidgets.QLineEdit(self.layoutWidget5)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(490, 20, 291, 41))
        ...
        self.filebeat_name = QtWidgets.QLineEdit(self.layoutWidget6)
        ...
        self.layoutWidget7.setGeometry(QtCore.QRect(20, 70, 321, 41))
        ...
        self.layoutWidget8.setGeometry(QtCore.QRect(20, 21, 461, 41))
        ...
        self.layoutWidget9.setGeometry(QtCore.QRect(20, 31, 781, 191))
        ...
        self.logstash_source = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.logstash_name = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.logstash_input_port = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.e_host = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.e_user = QtWidgets.QLineEdit(self.layoutWidget9)
        self.e_user.setText("elastic")
        self.e_user.setPlaceholderText("elastic")
        ...
        self.e_pass = QtWidgets.QLineEdit(self.layoutWidget9)
        self.e_pass.setText("")
        ...
        self.e_cloud_id = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.e_cloud_auth = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.logstash_name_5 = QtWidgets.QLineEdit(self.layoutWidget9)
        ...
        self.g_console.setGeometry(QtCore.QRect(30, 720, 821, 87))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logstash_cmd.setText(_translate("MainWindow", "Run Cmd test"))
    ...
    def close_event(self):
        list(map(memory_scheduler.cancel, memory_scheduler.queue))
        list(map(cpu_scheduler.cancel, cpu_scheduler.queue))
        MainWindow.destroy()
        exit()
    ...
    def button_click(self):
        global max_percent
        max_percent = self.memorySpinBox.value() / 100
        global loop
        loop = self.timeSpinBox.value()
        # create a thread
        memory_scheduler.enter(loop, 1, run_memory_check, (memory_scheduler,))
    ...
    def run_alarm(self):
        global time_loop, el_host, el_user, el_pass
        ...
        try:
            if self.memoryCheckBox.isChecked():
                global memory_max
                memory_max = self.memorySpinBox.value()
                memory_scheduler.enter(time_loop, 1, run_memory_check, (memory_scheduler,))
                thread = Thread(target=run_memory_scheduler)
                # run the thread
                thread.start()
                print("run memory alarm")
            if self.cpuCheckBox.isChecked():
                global cpu_max
                cpu_max = self.cpuSpinBox.value()
                cpu_scheduler.enter(time_loop, 1, run_cpu_check, (cpu_scheduler,))
                thread = Thread(target=run_cpu_scheduler)
                # run the thread
                thread.start()
                print("run cpu alarm")
...
def run_memory_scheduler():
    memory_scheduler.run()

def run_cpu_scheduler():
    cpu_scheduler.run()
