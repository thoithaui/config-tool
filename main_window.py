...
def run_memory_check(scheduler):
    ...
    scheduler.enter(loop, 1, run_memory_check, (scheduler,))
    get_latest_records(max_percent)
    # print("run {}".format(max_percent))
    # then do your stuff
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.endBtn.clicked.connect(self.endEvent)
    ...
    def buttonClick(self):
        ...
        # create a thread
        my_scheduler.enter(loop, 1, run_memory_check, (my_scheduler,))
